...
This guide describes how to customize the placement module `"placement.py" <placement.py>`_ to deal with a specific resource placement algorithm available in the placement package `"placementAlgo.jar" <placementAlgo.jar>`_. 
